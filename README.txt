...
2. UpdateCatalogs.Maker.exe - an .exe file that reads the <catalog name>.xml file then downloads and caches the DUPs.
...
1. From a command prompt, run UpdateCatalogs.Maker.exe using appropriate command line arguments, as noted below. 
...
=== Update Catalogs Maker Tool ===

(C) Copyright 2021, Dell Inc., All Rights Reserved.